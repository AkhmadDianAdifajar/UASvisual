...
begin
  ...
  begin
    zqry1.SQL.Clear;
    zqry1.SQL.Add('insert into ortu  values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+cbb1.Text+'","'+edt7.Text+'","'+cbb2.Text+'")');
    zqry1.ExecSQL ;
...
begin
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('UPDATE ortu SET nik="'+edt1.Text+'",nama="'+edt2.Text+'",pendidikan="'+edt3.Text+'",pekerjaan="'+edt4.Text+'",telp="'+edt5.Text+'",alamat="'+edt6.Text+'",jenis_kelamin="'+cbb1.Text+'",agama="'+edt7.Text+'",status="'+cbb2.Text+'" where id="'+id+'"');
    zqry1.ExecSQL;

...
begin
  ...
  begin
    zqry1.SQL.Clear;
    zqry1.SQL.Add('insert into wali values(null,"'+edt1.Text+'","'+edt2.Text+'","'+cbb1.Text+'""'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+cbb2.Text+'")');
    zqry1.ExecSQL ;

    zqry1.SQL.Clear;
    zqry1.SQL.Add('select * from wali');
    zqry1.Open;
...
begin
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('UPDATE wali SET nip="'+edt1.Text+'",nama="'+edt2.Text+'",jenis_kelamin="'+cbb1.Text+'",pendidikan="'+edt3.Text+'",telp="'+edt4.Text+'",alamat="'+edt5.Text+'",matpel="'+edt6.Text+'",status="'+cbb2.Text+'" where id="'+id+'"');
    zqry1.ExecSQL;
...
begin
  ...
  begin
    zqry1.SQL.Clear;
    zqry1.SQL.Add(' delete from wali where id="'+id+'"');
    zqry1. ExecSQL;
    zqry1.SQL.Clear;
    zqry1.SQL.Add('select * from wali');
    zqry1.Open;
